#!/usr/bin/env python3
"""Build the Lumina Desktop Beta R1 Windows setup executable."""
...
def main() -> int:
    ...
    output_root = (args.output_root or source_root / "dist" / "windows_installer_r1").resolve()
    output_root.mkdir(parents=True, exist_ok=True)

    release_builder = source_root / "deploy" / "windows_desktop_r1" / "build_lumina_windows_release_r1.ps1"
    subprocess.run(
        [
            "pwsh",
            "-NoProfile",
    ...
    payload_root = output_root / "work" / "LuminaDesktopBetaR1"
