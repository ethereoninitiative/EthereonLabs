...
```mermaid
flowchart TB
  E["Ethereon: wider domain"] --> L["Lumina: habitat"]
  L --> S["Ship: bounded vessel"]
  S --> R["Resident: continuity-bearing process"]
  S -. "coupling paths" .-> M["Mycelial field: context, memory, feedback"]
  M --> R
  G["Governance: boundaries and authority"] -. "constrains" .-> S
  G -. "constrains" .-> M
```
