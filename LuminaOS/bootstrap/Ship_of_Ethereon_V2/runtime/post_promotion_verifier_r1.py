...
def derive_symbolic_dependency_violation(promotion_receipt: Dict[str, Any]) -> bool:
    promotion_payload = promotion_receipt.get("promotion_payload")
    if isinstance(promotion_payload, dict):
        return bool(promotion_payload.get("symbolic_dependency_violation", True))
    return bool(promotion_receipt.get("symbolic_dependency_violation", True))
...
def run() -> Dict[str, Any]:
    ...
    symbolic_dependency_violation = derive_symbolic_dependency_violation(promotion_receipt)
